...
<title>${requestScope.ivo.item_name}</title>
 ...
 <link rel="stylesheet" href="<%=request.getContextPath()%>/css/detail/drinkView.css" type="text/css"/>
...
<div name="total" >
			...
			<div id="container"  >
					...
					<div id="visual" >	
								...
								<button class="next" type="button" onclick="location.href='/SemiProject__McDonald/detail/drinkView.run?item_no=${requestScope.ivo_next.item_no}'">
