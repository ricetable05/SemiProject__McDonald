...
$(document).ready(function() { 
	...
	var accordion_tab = $('.accordion1 p'), accordion_content = $('.accordion1 div');
        ...
        $("button.prev").click(function(){
       	 ...
       	 location.href='<%= request.getContextPath()%>/detail/sideView.run?item_no='+ prev_item_no;
        ...
        //       console.log("next_item_no : " + next_item_no); 
       	 ...
       	 location.href='<%= request.getContextPath()%>/detail/sideView.run?item_no='+ next_item_no;
...
<div id="container"  >
	...
	<div class="topimage" style="background-image: url(<%= request.getContextPath()%>/images/사이드상단이미지.jpg);">
		<div class="toptext">
